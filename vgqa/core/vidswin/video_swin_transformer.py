...
class VideoSwinTransformerBackbone(nn.Module):
    ...
    def __init__(self, backbone_pretrained: bool, backbone_pretrained_path, train_backbone: bool, **kwargs):
        ...
        if backbone_pretrained and isinstance(backbone_pretrained_path, str):
            if os.path.exists(backbone_pretrained_path):
                ...
                print(f'Warning: Pretrained weights not found at {backbone_pretrained_path}. Using random initialization.')
...
model_paths = {
    "video_swin_t_p4w7_k400_1k": "checkpoints/pretrained/swin_tiny_patch244_window877_kinetics400_1k.pth",
    "video_swin_s_p4w7_k400_1k": "checkpoints/pretrained/swin_small_patch244_window877_kinetics400_1k.pth",
}
