...
def gaussian_radius(det_size: Tuple[int, int], min_overlap: float = 0.7):
...
def draw_umich_gaussian(heatmap, center, radius, k: float = 1):
...
def draw_msra_gaussian(heatmap, center, sigma: float):
